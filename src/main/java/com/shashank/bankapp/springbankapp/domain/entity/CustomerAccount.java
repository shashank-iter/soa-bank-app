package com.shashank.bankapp.springbankapp.domain.entity;
...
public class CustomerAccount {
    ...
    private com.shashank.bankapp.springbankapp.enums.Currency currency;
